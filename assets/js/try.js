...
// Create a new DataTable to show selected values
...
// Handle checkbox click event in tableResarchcount1 to update selectedValuesTable
// Handle checkbox click event in tableResarchcount1 to update selectedValuesTable
// $('#nsrCount1 tbody').on('change', '.selectRow', function() {
//     var isChecked = $(this).prop('checked');
//     var rowData = tableResarchcount1.row($(this).closest('tr')).data();

//     if (isChecked) {
//         // Add row to selectedValuesTable
...
//         ]).draw(false);
//     } else {
//         // Remove row from selectedValuesTable
//         var rowIndex = selectedValuesTable.rows().indexes().toArray().find(index => {
//             return selectedValuesTable.row(index).data()[0] === rowData[1]; // Assuming Product Name is unique identifier
//         });

//         if (rowIndex !== undefined) {
//             selectedValuesTable.row(rowIndex).remove().draw(false);
//         } else {
//             console.error("Row not found in selectedValuesTable to remove.");
//         }
//     }
// });
 ...
 // Handle click event on #addProduct button
$('#addProduct').on('click', function(e) {
    e.preventDefault(); // Prevent default anchor behavior

    // Example: Get all checked checkboxes in tableResarchcount1
    var checkedRows = $('#nsrCount1 tbody .selectRow:checked');

    // Loop through checked checkboxes and add their corresponding rows to selectedValuesTable
    ...
    // Optionally reset checkboxes in tableResarchcount1 after processing
